...
while restart:
    ...
    city_selected = True
    if city == 'Chicago' or city == 'Chi' or city == 'chi':
        df = pd.read_csv('chicago.csv')
    elif city == 'New York' or city == 'NY' or city == 'ny' or city=='NYC':
        df = pd.read_csv('new_york_city.csv')
    elif city == 'Washington' or city == 'Wash' or city == 'wash':
        df = pd.read_csv('washington.csv')
    else:
        city_selected = False

    while city_selected is False:
        city = input("That's not a valid input. Could you please re-enter the city name/abbreviations in either format mentioned above.\n")
        city_selected = True
        if city == 'Chicago' or city == 'Chi' or city == 'chi':
            df = pd.read_csv('chicago.csv')
        elif city == 'New York' or city == 'NY' or city == 'ny' or city=='NYC':
    ...
    if filter=='month' or filter=='Month' or filter=='m':
        ...
        month_selection=input('Which month would you like to see the data for, January(jan),February(feb),March(mar),April(apr),May,June(jun)?\n\n')
        if month_selection=='Jan' or month_selection=='January' or month_selection=='jan':
            month_selection = 'January'
        elif month_selection=='Feb' or month_selection=='February' or month_selection=='feb':
            month_selection = 'February'
        elif month_selection=='Mar' or month_selection=='March' or month_selection=='mar':
            month_selection = 'March'
        elif month_selection=='Apr' or month_selection=='April' or month_selection=='apr':
            month_selection = 'April'
        elif month_selection=='May' or month_selection=='may' or month_selection=='MAY':
            month_selection = 'May'
        elif month_selection=='June' or month_selection=='jun' or month_selection=='Jun':
        ...
        if day_selection=='Mon' or 'mon':
            day_selection='Monday'
        elif day_selection=='Tu' or 'tu':
            day_selection='Tuesday'
        elif day_selection == 'Wed' or 'wed':
            day_selection ='Wednesday'
        elif day_selection == 'Thurs' or 'thurs':
            day_selection ='Thursday'
        elif day_selection == 'Fri' or 'fri':
            day_selection ='Friday'
        elif day_selection == 'Sat' or 'sat':
            day_selection ='Saturday'
        elif day_selection == 'Sun' or 'sun':
